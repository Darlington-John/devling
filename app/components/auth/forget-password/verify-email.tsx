				...
				<div className="flex justify-center gap-2 w-full text-white">
					{verificationCode.slice(0, 4).map((digit, index) => (
						<input
							...
							maxLength={1}
							className={`text-[22px]   outline-none px-2 py-3 rounded-md w-full bg-grey text-center focus:ring-2 ring-white  h-[56px]  text-white  grow-0 shrink-0 max-w-[55px]  max-h-[56px]  ${
