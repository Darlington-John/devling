...
const EditCategoryPrompt = ({
	...
	useEffect(() => {
		if (categoryToEdit) {
			...
			setDesc(categoryToEdit.description || '');
	...
	const editCategory = async () => {
		...
		formData.append('category', categoryToEdit?._id);
		await apiRequest({
			url: '/api/categories/edit-category',
			method: 'PATCH',
			body: formData,
			onSuccess: (response) => {
				setSuccessful(true);
...
export default EditCategoryPrompt;
